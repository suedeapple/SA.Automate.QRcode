...
public sealed class GenerateQrCodeOutput
{
    ...
    /// <summary>Gets the output format the QR code was rendered in, e.g. "PngDataUri".</summary>
    public string? OutputFormat { get; init; }

    /// <summary>Gets the generated QR code content: a data URI, raw base64 string, or SVG markup, depending on the output format.</summary>
